...
prompt_input = """Summarise this website %s
                ...
                Combined list: [{destination 1 name: "", destination 1 category: %s, destination 1 description: "", "destination 1 budgetRange": "", "destination 1 openingHours": "", "destination 1 website": ""}, 
                {"destination 2 name": "", destination 2 category: %s, "destination 2 description": "", "destination 2  budgetRange": "", "destination 2 openingHours": "", "destination 2 website": ""}].
...
def get_llama_foodgalore(city, country, budget, dietary_restrictions, pre_prompt=pre_prompt, prompt_input=prompt_input):
    ...
    prompt_input = prompt_input % (site, city, country, budget, dietary_restrictions, "Food Galore", "Food Galore") 
